    ...
    <div class=" col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-2 col-form-label ">Exam Pass Marks Per Question 1 Marks</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-2 col-form-label ">Exam Total Marks Per Question 1 Marks</label>
                    <div class="col-md-4">
